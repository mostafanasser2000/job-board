...
from core.models import Job, Industry, Location, Company, Skill
...
class CompanyModelTest(TestCase):
    ...
    def test_company_creation(self):
        company = Company.objects.create(
            name="Test Company", location=self.location, company_size=1
        )
...
class JobModelTest(TestCase):
    ...
    def setUpTestData(cls):
        cls.location = Location.objects.create(city="Cairo", country="Egypt")
        cls.company = Company.objects.create(name="Test Company", location=cls.location)
